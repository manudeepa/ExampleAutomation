...
public class sdemo5
{
	...
	{
		BrowserDemo5.LaunchBrowser();
		BrowserDemo5.navigate();
		BrowserDemo5.login();
		BrowserDemo5.minimizeFlyOutWindow();
		BrowserDemo5.createcusomer();
		BrowserDemo5.CreateProject();
		BrowserDemo5.DeleteProject();
		BrowserDemo5.deleteustomer();
		BrowserDemo5.logout();
		BrowserDemo5.closeapplication();
	}
